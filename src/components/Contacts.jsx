...
import { RiGithubFill, RiLinkedinFill, RiTwitterFill, RiTwitterXFill } from "@remixicon/react"
...
const Contacts = () => {
  return (
    ...
    md:px-10" id="contact">
        ...
        <motion.h3
        className="text-8xl md:text-6xl leading-none"
        initial="hidden"
        whileInView="visible"
        custom={0.4}
        ...
        <motion.a 
        href={`mailo.${CONTACT_CONTENT.email}`}
